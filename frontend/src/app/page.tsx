      ...
      <div className="max-w-3xl mx-auto px-4 py-6 space-y-5">
        {isLoading && (
          <div className="text-center py-12">
            <div className="inline-flex items-center gap-3 text-white">
              ...
              <span className="text-sm">Querying FEMA, NOAA, World Bank...</span>
            </div>
          </div>
        )}
        ...
        {!report && !isLoading && !error && (
          <div className="text-center py-4">
            <RiskMap report={null} />
            <p className="mt-4 text-blue-200 text-sm opacity-60">
        ...
        <div className="text-center text-blue-300 text-xs pb-6 opacity-50">
          Open source · Built with FEMA, NOAA, World Bank, CLIMADA & Claude AI ·{" "}
          <a href="https://github.com/geosphy/climate-risk-intel" className="hover:underline" target="_blank" rel="noopener noreferrer">
            GitHub
          </a>
        </div>
      </div>
